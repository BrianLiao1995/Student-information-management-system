...
class PHPExcel_Style_Borders extends PHPExcel_Style_Supervisor implements PHPExcel_IComparable
{
    ...
    /**
     * All borders psedo-border. Only applies to staffs.
     *
     * @var PHPExcel_Style_Border
     */
    ...
    /**
     * Outline psedo-border. Only applies to staffs.
     *
     * @var PHPExcel_Style_Border
     */
    protected $outline;
    ...
    /**
     * Inside psedo-border. Only applies to staffs.
     *
     * @var PHPExcel_Style_Border
     */
    protected $inside;
    ...
    /**
     * Vertical pseudo-border. Only applies to staffs.
     *
     * @var PHPExcel_Style_Border
     */
    protected $vertical;
    ...
    /**
     * Horizontal pseudo-border. Only applies to staffs.
     *
     * @var PHPExcel_Style_Border
     */
     ...
     *
     * @param    boolean    $isSupervisor    Flag indicating if this is a staffs or not
    ...
    public function __construct($isSupervisor = false, $isConditional = false)
    {
        ...
        if ($isSupervisor) {
            ...
            // bind parent if we are a staffs
    ...
    /**
     * Get AllBorders (pseudo-border). Only applies to staffs.
     *
     * @return PHPExcel_Style_Border
     * @throws PHPExcel_Exception
     */
    ...
    {
        if (!$this->isSupervisor) {
            throw new PHPExcel_Exception('Can only get pseudo-border for staffs.');
        }
        return $this->allBorders;
    }

    /**
     * Get Outline (pseudo-border). Only applies to staffs.
     *
     * @return boolean
     * @throws PHPExcel_Exception
     */
    ...
    /**
     * Get Inside (pseudo-border). Only applies to staffs.
     *
     * @return boolean
     * @throws PHPExcel_Exception
     */
    ...
    /**
     * Get Vertical (pseudo-border). Only applies to staffs.
     *
     * @return PHPExcel_Style_Border
     * @throws PHPExcel_Exception
     */
    ...
    /**
     * Get Horizontal (pseudo-border). Only applies to staffs.
     *
     * @return PHPExcel_Style_Border
     * @throws PHPExcel_Exception
     */
