            ...
            <div class="photos">
                ...
                <div align="center" style="padding: 5px">
                    ...
                    <table>
                        <tr>
                            <td>
                                <input onclick="changePassword(document.getElementById('users_id').value);"
                                       name="submit" value="进行密码修改" type="submit"
                                       class="button_style"/>
                            </td>
                            <td>
                                <input onclick="changeEmail(document.getElementById('users_id').value);"
                                       name="submit" value="进行邮箱修改" type="submit"
                                       class="button_style"/>
                            </td>
                        </tr>
                    </table>
