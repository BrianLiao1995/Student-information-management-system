...
<head>
    ...
    <script type="text/javascript" src="../../js/uploadUsersExcel.js"></script>
    <script type="text/javascript">
        function download() {
            window.location.href = "users_example.xlsx";
        }
    </script>
</head>
<body>
    ...
    <div class="contain">
        ...
        <div class="main">
            <div class="photos" align="center">
                ...
                <input onclick="uploadUsersExcel()" type="submit" name="submit">
            </div>
        </div>
        <div class="clear"></div>
    </div>
